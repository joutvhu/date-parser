...
public class ZoneUtil {
    ...
    static {
        ...
        putNames("ART:-03:00", "ART", "Argentina Standard Time", "Buenos Aires");
        putNames("AST:-04:00", "AST", "Atlantic Standard Time", "Atlantic Time", "Atlantic Time (Canada)");
        putNames("ARAB:+03:00", "ARAB", "Arab Standard Time", "Kuwait", "Riyadh");
        putNames("ARABIA:+04:00", "ARABIA", "Arabian Standard Time", "Abu Dhabi", "Muscat");
        putNames("ARABIC:+03:00", "ARABIC", "Arabic Standard Time", "Baghdad");
        putNames("AWST:+08:00", "AWST", "Australian Western Standard Time", "W. Australia Standard Time", "Perth");
        putNames("AZOST:-01:00", "AZOST", "Azores Standard Time", "Azores");
        putNames("AZT:+04:00", "AZT", "Azerbaijan Time", "Azerbaijan Standard Time", "Baku");
        putNames("CAST:-06:00", "CAST", "Central America Standard Time", "Central America");
        ...
        putNames("CEST:+01:00", "CEST", "Central European Standard Time", "Sarajevo", "Skopje", "Warsaw", "Zagreb");
        putNames("CCS:+04:00", "CCS", "Caucasus Time", "Caucasus Standard Time", "Caucasus Standard Time");
        putNames("CGT:-03:00", "CGT", "Greenland Standard Time", "Greenland");
        putNames("CHN:+08:00", "CHN", "China Standard Time", "Beijing", "Chongqing", "Hong Kong", "Urumqi");
        putNames("CPST:+11:00", "CPST", "Central Pacific Standard Time", "Magadan", "Solomon Is.", "New Caledonia");
        putNames("CST:-06:00", "CST", "Central Standard Time", "Central Time (US & Canada)");
        putNames("CSTM:-06:00", "CSTM", "Central Standard Time (Mexico)", "Guadalajara", "Mexico City", "Monterrey - New");
        putNames("CVT:-01:00", "CVT", "Cape Verde Time", "Cape Verde Standard Time", "Cape Verde Is.");
        putNames("DST:-12:00", "DST", "Dateline Standard Time", "International Date Line West");
        ...
        putNames("EGY:+02:00", "EGY", "Egypt Standard Time", "Cairo");
        putNames("EKB:+05:00", "EKB", "Ekaterinburg Standard Time", "Ekaterinburg");
        putNames("ESAST:-03:00", "ESAST", "South America Eastern Standard Time", "E. South America Standard Time", "Brasilia");
        putNames("EST:-05:00", "EST", "Eastern Standard Time", "Eastern Time (US & Canada)");
        putNames("FJT:+12:00", "FJT", "Fiji Standard Time", "Fiji", "Kamchatka", "Marshall Is.");
        putNames("FLE:+02:00", "FLE", "FLE Standard Time", "Helsinki", "Kyiv", "Riga", "Sofia", "Tallinn", "Vilnius");
        ...
        putNames("GST:GMT", "GST", "Greenwich Standard Time", "Monrovia", "Reykjavik");
        putNames("GTB:+02:00", "GTB", "GTB Standard Time", "Athens", "Bucharest", "Istanbul");
        putNames("HAST:-10:00", "HAST", "Hawaii-Aleutian Standard Time", "Hawaiian Standard Time", "Hawaii");
        putNames("IRST:+03:30", "IRST", "Iran Standard Time", "Tehran");
        putNames("IST:+05:30", "IST", "India Standard Time", "Chennai", "Kolkata", "Mumbai", "New Delhi");
        putNames("ISRAEL:+02:00", "ISRAEL", "Israel Standard Time", "Jerusalem");
        putNames("JRD:+02:00", "JRD", "Jordan Standard Time", "Amman");
        putNames("JST:+09:00", "JST", "Japan Standard Time", "Tokyo Standard Time", "Osaka", "Sapporo", "Tokyo");
        putNames("KST:+09:00", "KST", "Korea Standard Time", "Seoul");
        putNames("MAST:-02:00", "MAST", "Mid-Atlantic Standard Time", "Mid-Atlantic");
        putNames("MEST:+02:00", "MEST", "Middle East Standard Time", "Beirut");
        putNames("MMT:+06:30", "MMT", "Myanmar Standard Time", "Yangon (Rangoon)");
        putNames("MRC:GMT", "MRC", "Morocco Standard Time", "Casablanca");
        putNames("MSK:+03:00", "MSK", "Moscow Standard Time", "Russian Standard Time", "Moscow", "St. Petersburg", "Volgograd");
        putNames("MST:-07:00", "MST", "Mountain Standard Time", "Mountain Time (US & Canada)");
        putNames("MSTM:-07:00", "MSTM", "Mountain Standard Time (Mexico)", "Chihuahua", "La Paz", "Mazatlan - New");
        putNames("MUT:+04:00", "MUT", "Mauritius Time", "Mauritius Standard Time", "Port Louis");
        putNames("MVD:-03:00", "MVD", "Montevideo Standard Time", "Montevideo");
        putNames("NAEST:+08:00", "NAEST", "North Asia East Standard Time", "Irkutsk", "Ulaan Bataar");
        putNames("NAST:+07:00", "NAST", "North Asia Standard Time", "Krasnoyarsk");
        putNames("NCAST:+06:00", "NCAST", "North Central Asia Standard Time", "Almaty", "Novosibirsk");
        ...
        putNames("NZST:+12:00", "NZST", "New Zealand Standard Time", "Auckland", "Wellington");
        putNames("PSA:-04:00", "PSA", "Pacific South America Time", "Pacific SA Standard Time", "Santiago");
        putNames("PST:-08:00", "PST", "Pacific Standard Time", "Pacific Time (US & Canada)");
        putNames("PSTM:-08:00", "PSTM", "Pacific Standard Time (Mexico)", "Tijuana", "Baja California");
        putNames("PAK:+05:00", "PAK", "Pakistan Standard Time", "Islamabad", "Karachi");
        putNames("ROM:+01:00", "ROM", "Romance Standard Time", "Brussels", "Copenhagen", "Madrid", "Paris");
        putNames("SAEST:-03:00", "SAEST", "SA Eastern Standard Time", "Georgetown");
        putNames("SAPST:-05:00", "SAPST", "SA Pacific Standard Time", "Bogota", "Lima", "Quito", "Rio Branco");
        putNames("SAST:+02:00", "SAST", "South Africa Standard Time", "Harare", "Pretoria");
        putNames("SAWST:-04:00", "SAWST", "SA Western Standard Time", "La Paz");
        putNames("SEA:+07:00", "SEA", "SE Asia Standard Time", "Bangkok", "Hanoi", "Jakarta");
        putNames("SLST:+05:30", "SLST", "Sri Lanka Standard Time", "Sri Jayawardenepura");
        ...
        putNames("SST:+08:00", "SST", "Singapore Standard Time", "Kuala Lumpur", "Singapore");
        putNames("TON:+13:00", "TON", "Tonga Standard Time", "Nuku'alofa");
        putNames("TSM:+10:00", "TSM", "Tasmania Standard Time", "Hobart");
        putNames("TWT:+08:00", "TWT", "Taiwan Time", "Taipei Standard Time", "Taipei");
        putNames("USEST:-05:00", "USEST", "US Eastern Standard Time", "Indiana (East)");
        putNames("USMST:-07:00", "USMST", "US Mountain Standard Time", "Arizona");
        putNames("UTC:GMT", "UTC", "Coordinated Universal Time");
        putNames("VNZ:-04:30", "VNZ", "Venezuela Time", "Venezuela Time Zone", "Caracas");
        putNames("VVS:+10:00", "VVS", "Vladivostok Standard Time", "Vladivostok");
        putNames("WAT:+05:00", "WAT", "West Asia Standard Time", "Tashkent");
        ...
        putNames("WPT:+10:00", "WPT", "West Pacific Standard Time", "Guam", "Port Moresby");
        putNames("YAKT:+09:00", "YAKT", "Yakutsk Standard Time", "Yakutsk");
    }
