...
public class DateFormatter implements Formatter {
    ...
    private final Map<Class<?>, Convertor<?>> convertors = new HashMap<>();
     ...
     */
    public <T> DateFormatter withConvertor(Class<T> typeOfConvertor, Convertor<T> convertor) {
     ...
     * @return The current date parser.
     */
    public <T> DateFormatter withConvertor(Convertor<T> convertor) {
        Class<T> typeOfConvertor = Convertor.typeOfConvertor(convertor);
        Objects.requireNonNull(typeOfConvertor);
        return this.withConvertor(typeOfConvertor, convertor);
    }
     ...
     * @return The current date parser.
     */
    public DateFormatter withLocale(Locale defaultLocale) {
     ...
     * @return The current date parser.
     */
    public DateFormatter withZone(TimeZone defaultZone) {
     ...
     * @return The current date parser.
     */
    public DateFormatter withWeekFields(WeekFields defaultWeekFields) {
     ...
     * @return The current date parser.
     */
    public DateFormatter withStrategyFactory(StrategyFactory strategyFactory) {
